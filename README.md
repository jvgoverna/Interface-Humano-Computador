...
4d) Esquema conceitual de signos: Previsões (gráficos de 24 meses)
| signo                                  | origem  | observações                                                                                               | tipo de conteúdo                | restrições sobre o conteúdo                                                       | valor default     | prevenção                                                                                   | recuperação                                                                                 |
|----------------------------------------|---------|------------------------------------------------------------------------------------------------------------|---------------------------------|------------------------------------------------------------------------------------|-------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| Menu → “Previsões”                     | sistema | Acesso pela tela de simulação (menu superior).                                                             | navegação                       | Disponível para usuários autenticados.                                             | item visível      | -                                                                                           | -                                                                                           |
| botão **Selecionar ação** (lista de recomendadas) | sistema | Ao clicar, abre as **opções de todas as ações recomendadas** na última simulação; ao escolher, atualiza o gráfico abaixo. Para ver outra, **clique novamente no botão** e troque a ação. | controle de ação (botão/dropdown ou modal) | - | botão habilitado; nenhuma ação selecionada | PP: desabilitar quando lista vazia; | - |
| gráfico de previsão por ação (24m)     | sistema | Exibe a **curva prevista (24 meses)** e a **estimativa percentual de 24m** para a ação selecionada via botão **Selecionar ação**. | visualização de dados (gráfico) | - | não exibido       | PP: indicadores de eixo/legenda; cores consistentes; | RA: permitir recarregar/selecionar outra ação. |
| troca de ação (re-seleção pelo botão)  | sistema | Para analisar outro papel, o usuário **abre novamente o botão** **Selecionar ação** e escolhe um novo ticker; o gráfico é atualizado. | controle de navegação           | - | na 1ª ação vista  | - | - |
