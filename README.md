...
![Investidor 10](https://media.discordapp.net/attachments/1372327706980651028/1431096790932783305/Investidor10_1.jpeg?ex=68fc2c3f&is=68fadabf&hm=6ac6280a1ee81ceb96f8ec74cd8dd3aa687474195cc44a5c83da4924a03ac803&=&format=webp&width=1376&height=931)
...
![statusInvest](https://media.discordapp.net/attachments/1372327706980651028/1431096889289211914/StatusInvest.jpeg?ex=68fc2c56&is=68fadad6&hm=8cd3f6d14b2f3eb3441bc00ecc52eb09b4889504f38152adf52783b7808c4f90&=&format=webp)
...
![Prototipação em Papel 1](https://media.discordapp.net/attachments/1372327706980651028/1433272937741291590/image.png?ex=690416f1&is=6902c571&hm=c1a51169faf66f49bb2c42b26329653620b4e52fe0f58b9a07f1cf8c986f67be&=&format=webp&quality=lossless)
...
![Prototipação em Papel 2](https://media.discordapp.net/attachments/1372327706980651028/1433273202934677614/image.png?ex=69041730&is=6902c5b0&hm=3c3ed4c38740177f1e09a2e9d9d64f488d8ad6ce033cdcb31a6d95a50c1502d8&=&format=webp&quality=lossless)
...
**4a) Esquema conceitual de signos: Cadastrar na plataforma (com Termos e Política)**
| signo                                                   | origem  | observações                                                                                                           | tipo de conteúdo                     | restrições sobre o conteúdo                                                                                          | valor default                      | prevenção                                                                                                                   | recuperação                                                                                                  |
|---------------------------------------------------------|---------|------------------------------------------------------------------------------------------------------------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------------|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| formulário de cadastro (nome, CPF, data nasc., telefones, e-mail, senha) | sistema | Telefone residencial é opcional; data de nascimento não aceita valores futuros.                                       | interação de usuário (formulário)    | **E-mail** e **CPF** válidos e **únicos**; **aceite dos termos/política é obrigatório** | campos vazios; obrigatórios com * | **PP:** máscara/validação de CPF/e-mail; realce de campo inválido. **PA:** botão desabilitado até completar + aceitar. | **RA:** mensagem clara no(s) campo(s) com erro; manter campos válidos e permitir correção imediata.          |
| checkbox de aceite (Termos de Uso & Política de Privacidade) + links    | sistema | Checkbox “Li e aceito…”. Links abrem os textos completos e têm ação de **voltar** para o cadastro sem perder dados.   | interação de usuário (checkbox+links)| Aceite **obrigatório** para concluir o cadastro                                                                       | checkbox desmarcado               | **PA:** botão **Cadastrar** só habilita após marcar o aceite; **PP:** tooltip/nota “marque para prosseguir”.                | **RA:** ao retornar dos textos, o estado do formulário é preservado; marcar o checkbox e prosseguir.         |
...
**4b) Esquema conceitual de signos: Login na plataforma**
| signo                            | origem  | observações                                                                                   | tipo de conteúdo                  | restrições sobre o conteúdo                                  | valor default  | prevenção                                                                                 | recuperação                                                                                 |
|----------------------------------|---------|------------------------------------------------------------------------------------------------|-----------------------------------|---------------------------------------------------------------|----------------|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| e-mail e senha (campos)          | sistema | Credenciais informadas pelo usuário para acesso.                                               | interação de usuário (formulário) | Ambos obrigatórios; e-mail em formato válido.                 | campos vazios  | **PP:** validação imediata; foco no campo com erro.                                        | **RA:** ao erro, exibir mensagem “credenciais inválidas” e manter valores para correção.    |
...
| signo                                       | origem  | observações                                                                                               | tipo de conteúdo                       | restrições sobre o conteúdo                                                                 | valor default                | prevenção                                                                                                           | recuperação                                                                                             |
|--------------------------------------------|---------|------------------------------------------------------------------------------------------------------------|----------------------------------------|----------------------------------------------------------------------------------------------|------------------------------|---------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| orçamento (campo)                           | sistema | Campo para informar o valor total disponível para investir.                                               | interação de usuário (formulário)      | Deve ser numérico e > 0.                                                                                          | vazio                        | PP: máscara de moeda; validação imediata (✓/✕).                                                                     | RA: mensagem de erro; mantém valor digitado para correção.                                             |
| ações para simular (seleção + valor)        | sistema | Seleção de **≥ 3 ações** e valor a alocar em cada uma.                                                    | interação de usuário (formulário)      | Mínimo **3 ações**; cada valor ≥ 0;                                                           | lista vazia                  | PP: aviso em vermelho se < 3 ações;              | RA: destaca o(s) campo(s) inválido(s); permite ajuste sem perder entradas válidas.                     |
| horizonte (6/12/24 meses)                   | sistema | Escolha do período da simulação (ex.: **6 meses** para ganhos rápidos).                                   | interação de usuário (controle de opção)| Deve existir exatamente uma opção selecionada: 6, 12 ou 24.                                                        | nenhuma opção marcada        | PA: botão **Simular Portfólio** desabilitado enquanto não houver horizonte selecionado.                             | RA: mantém seleção anterior ao voltar de outra tela.                                                   |
| botão “Simular Portfólio”                   | sistema | Submete a simulação quando todas as regras forem atendidas.                                               | controle de ação                       | Só habilita com orçamento válido, ≥ 3 ações e horizonte marcado.                               | desabilitado                 | PA: permanece desabilitado até cumprir regras.                                     | RA: em caso de erro de backend, mostra mensagem e permite reenvio.                                     |


4d) Esquema conceitual de signos: Recomendação de carteiras de investimento (IA)
| signo                                           | origem  | observações                                                                                                             | tipo de conteúdo                   | restrições sobre o conteúdo                                                       | valor default              | prevenção                                                                                     | recuperação                                                                                  |
|------------------------------------------------|---------|--------------------------------------------------------------------------------------------------------------------------|------------------------------------|------------------------------------------------------------------------------------|----------------------------|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| bloco “Recomendação da IA (6/12/24m)”          | sistema | Mostra **apenas as ações recomendadas** para o horizonte escolhido, com **lucro total estimado** do portfólio.         | comportamento do sistema (resumo)  | Requer simulação válida (≥ 3 ações, soma = orçamento, horizonte selecionado).     | não exibido                | PA: não renderiza sem simulação válida; mensagens objetivas caso falte algum requisito.      | RA: instrução para “ajustar seleção e reenviar”; mantém orçamento/seleções previamente feitos. |
| item de recomendação por ação                  | sistema | Para cada ação recomendada: **ticker**, **valor sugerido (R$)** e **estimativa de crescimento no horizonte**.           | comportamento do sistema (lista)   | Itens correspondem aos tickers elegíveis no horizonte; valores devem somar ≤ orçamento. | lista vazia                | PP: formatação com sinais (+/−); clareza por ação; ordenação por maior potencial.            | RA: ao atualizar modelo, reprocessa mantendo o mesmo horizonte selecionado.                   |


4e) Esquema conceitual de signos: Previsões (gráficos de 24 meses)
| signo                                  | origem  | observações                                                                                               | tipo de conteúdo                | restrições sobre o conteúdo                                                       | valor default     | prevenção                                                                                   | recuperação                                                                                 |
|----------------------------------------|---------|------------------------------------------------------------------------------------------------------------|---------------------------------|------------------------------------------------------------------------------------|-------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| Menu → “Previsões”                     | sistema | Acesso pela tela de simulação (menu superior).                                                             | navegação                       | Disponível para usuários autenticados.                                             | item visível      | PA: se não houver simulação anterior, exibir aviso “Realize uma simulação para ver previsões”. | RA: botão “Voltar para Simulação” para iniciar/ajustar a simulação.                        |
| lista de ações recomendadas (para ver) | sistema | Lista dos **tickers recomendados** na última simulação válida.                                            | visualização (lista)            | Lista populada apenas se a simulação gerou recomendação.                           | lista vazia       | PP: desabilitar seleção quando lista vazia; mostrar orientação para simular primeiro.        | RA: após simular, a lista é preenchida automaticamente.                                    |
| gráfico de previsão por ação (24m)     | sistema | Exibe a **curva prevista (24 meses)** e a **estimativa percentual de 24m** para a ação selecionada.       | visualização de dados (gráfico) | Apenas para as ações recomendadas; horizonte fixo **24 meses**.                    | não exibido       | PP: indicadores de eixo/legenda; cores consistentes; loading state enquanto carrega.        | RA: fallback textual “estimativa (24m)” se a série não estiver disponível; permitir recarga. |
| navegação entre ações                  | sistema | Botões **Anterior/Próxima** e seletor direto por ticker.                                                  | controle de navegação            | —                                                                                  | na 1ª ação         | PP: mostrar indicador “1/3, 2/3, 3/3”; impedir navegação além dos limites.                  | RA: retorna à última ação vista ao reabrir a página.                                        |
