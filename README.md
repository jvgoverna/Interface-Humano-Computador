...
| Perfil de Investidor | sistema/usuário | Tela de disponibilização do questionário de suitability para preenchimento do usuário | interação de usuário (questionário) | Para o envio do questionário é necessário que o usuário preencha ele por completo | Campos para resposta vazios | PA: O sistema bloqueia o envio do questionário de suitability enquanto não estiver totalmente preenchido, garantindo que todos os dados sejam fornecidos| - |
<!--
