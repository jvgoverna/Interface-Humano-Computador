...
| redirecionamento pós-cadastro                            | sistema | Após sucesso, mostra “**Cadastro concluído**” e redireciona para **Login**.                                           | comportamento do sistema              | Apenas após persistência bem-sucedida                                                                                  | -                                  | **PP:** confirmação visual antes do redirecionamento; | **RA:** se falhar a gravação, exibir erro e **manter o formulário preenchido** para novo envio.               |
